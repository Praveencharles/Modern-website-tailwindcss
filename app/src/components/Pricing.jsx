import { Check, StampIcon, Star } from "lucide-react";

const plans = [
  {
    name: "Starter",
    price: "49.99",
    description: "Perfect for individuals and smaller teams",
    features: [
  ...
  },
  {
    name: "Professional",
    price: "99.99",
    description: "Best for growing bussiness",
    features: [
      "Up to 5 team members",
      "10GB storage",
      "Basic analytics",
    ...
    >
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12 ms:mb-16 lg:mb-20 ">
          ...
          <p className="text-gray-100 text-base text-xl sm:text-lg max-w-2xl mx-auto">
            Choose the perfect plan for your needs. All plan include a 14-day
            fee trial.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-6">
          {plans.map((plan, key) => {
            return (
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-br from-white/10 via-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 transform -translate-x-full -translate-y-full group-hover:translate-x-0 group-hover:translate-y-0 pointer-events-none rounded-xl " />
                ...
                <div className="text-center mb-6 sm:mb-8 ">
                  ...
                  <div className="flex items-baseline justify-center ">
                    <span className="text-3xl sm:text-4xl lg:text-5xl font-bold bg-gradient-to-b from-blue-700 to-cyan-400 bg-clip-text text-transparent">
                      ${plan.price}
                    </span>
                  ...
                  {plan.features.map((feature, featureKey) => {
                    return (
                      ...
                      >
                        ...
                        <span className="text-gray-300 text-sm sm:tetx-base">
                          {feature}
                        </span>
                      </li>
                    );
